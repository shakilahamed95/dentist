        ...
        <div className="card lg:max-w-lg bg-base-100 shadow-xl">
            <div className="card-body">
                ...
                <div className="card-actions justify-center">
                    <label htmlhtmlFor="booking-modal" onClick={() => setTreatment(service)} disabled={slots.length === 0} className="btn btn-secondary uppercase modal-button">Book Now</label>
                </div>
            </div>
        </div>
    );
